...
- **Architectural** — new projects, new subsystems, changes that
  ...
  design, written spec, then the sr-writing-plans skill.
...
8. **Transition to implementation** — invoke sr-writing-plans skill to create implementation plan

**Terminal states are path-bound.** Architectural: the ONLY skill you
invoke after brainstorming is sr-writing-plans — never any
...
**Implementation:**
- Invoke the sr-writing-plans skill to create a detailed implementation plan
- Do NOT invoke any other skill. sr-writing-plans is the next step.
